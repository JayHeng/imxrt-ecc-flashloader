...
#else
#define BL_CONFIG_HS_USB_HID (0U)
#endif
...
#define BL_FEATURE_KEY_STORE_PUF (1)
...
#define BL_FEATURE_FLEXSPI_NOR_XECC_WRITE_ENABLE (1)
#define BL_FEATURE_FLEXSPI_NOR_XECC_REGION_UNIT (0x1000)
